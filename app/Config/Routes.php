...
$routes->post('/objectives/update_progress/(:num)', 'Objectives::update_progress/$1', ['filter' => 'auth']);
...
$routes->post('/performance/close_calculation/(:num)', 'Performance::close_calculation/$1', ['filter' => 'auth']);
...
$routes->post('/shifts/update/(:num)', 'Shifts::update/$1', ['filter' => 'auth']);
$routes->post('/shifts/toggle/(:num)', 'Shifts::toggle/$1', ['filter' => 'auth']);
$routes->post('/shifts/approve/(:num)', 'Shifts::approve/$1', ['filter' => 'auth']);
...
$routes->post('/users/toggle_status/(:num)', 'Users::toggleStatus/$1', ['filter' => 'auth']);
...
$routes->post('/schedules/update/(:num)', 'Schedules::update/$1', ['filter' => 'auth']);
$routes->post('/schedules/delete/(:num)', 'Schedules::delete/$1', ['filter' => 'auth']);
...
$routes->post('/departments/update/(:num)', 'Departments::update/$1', ['filter' => 'auth']);
$routes->post('/departments/delete/(:num)', 'Departments::delete/$1', ['filter' => 'auth']);
...
$routes->post('/absences/update_status/(:num)', 'Absences::updateStatus/$1', ['filter' => 'auth']);
$routes->get('/absences/attachment/(:num)', 'Absences::attachment/$1', ['filter' => 'auth']);
$routes->get('/absences/preview/(:num)', 'Absences::preview/$1', ['filter' => 'auth']);

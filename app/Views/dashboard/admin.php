                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                            Trabajando Ahora</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= count($workingNow) ?> Empleados</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-md-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-white d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Turnos Cubiertos en el Mes</h6>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif($se['total_shifts'] < 2): ?>
                                    <span class="badge bg-warning text-dark">Bajo Trabajo</span>
                                <?php else: ?>
    ...
    <div class="col-md-3">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-danger text-white">
                <h6 class="m-0 font-weight-bold">Alerta: Sobrecarga</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-3">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-warning">
                <h6 class="m-0 font-weight-bold text-dark">Baja Asignación</h6>
            </div>
            <div class="card-body">
...
<div class="row">
    <!-- Empleados Actualmente Activos (Detalle) -->
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-white">
                <h6 class="m-0 font-weight-bold text-success">Personal Activo en este momento</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-primary text-white d-flex justify-content-between">
                <h6 class="m-0 font-weight-bold">Calendario Interactivo de Turnos</h6>
...
<!-- Modal para Asignar Turno Abierto -->
